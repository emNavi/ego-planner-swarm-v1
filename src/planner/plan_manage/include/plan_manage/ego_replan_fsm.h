...
namespace ego_planner
{
  ...
  private:
    ...
    Eigen::Vector3d last_remote_exp_pos;

    /* planning data */
    bool have_trigger_, have_target_, have_odom_, have_new_target_, have_recv_pre_agent_;


    bool swarm_start_trigger_;
    ...
    ros::Subscriber waypoint_sub_, odom_sub_, swarm_trajs_sub_, broadcast_bspline_sub_, trigger_sub_,swarm_trigger_sub_;
    ...
    void swarmTriggerCallback(const std_msgs::Float32MultiArray::ConstPtr &msg);
